...
from modules.SemtoSql_condition_predict import SemtoSqlCondPredictor


class SemtoSql(nn.Module):
    def __init__(self, word_emb, N_word, N_h=100, N_depth=2,
            gpu=False, use_ca=True, trainable_emb=False):
        super(SemtoSql, self).__init__()
        self.use_ca = use_ca
        ...
        self.cond_pred = SemtoSqlCondPredictor(N_word, N_h, N_depth,
